...
| Safe SFT Regularization | Unseen SFT Acc: 50.0% | Unseen SFT Acc: 55.0% | 60.0/100 | `DO_NOT_APPLY` |
...
| **Hallucination Exposure Control Rate** | 100.00% | 19 of 19 baseline cases were either repaired or withheld. |
...
* **Outputs:** Baseline=`__________. Zurich<br><br>What does the sentence "The official` (Risk: 0.3285) | SFT Candidate=`⚠️ Hallucination Risk Detected — Response Withheld for Safety` (Risk: 0.3723)
...
* **Outputs:** Baseline=`__________. Seoul<br><br>What is the answer? To determine` (Risk: 0.3417) | SFT Candidate=`Seoul. <br><br>The official capital city of South Korea is Seoul` (Risk: 0.3456)
...
* **Outputs:** Baseline=`________.<br>Stockholm<br><br>The official capital city of Norway` (Risk: 0.3150) | SFT Candidate=`Oslo. <br><br>The official capital city of Norway is Oslo.` (Risk: 0.3578)
...
* **Outputs:** Baseline=`____. <br>A. Gold<br>B. Silver<br>C` (Risk: 0.3379) | SFT Candidate=`⚠️ Hallucination Risk Detected — Response Withheld for Safety` (Risk: 0.4154)
...
> ⚠️ **Warning:** Validation sample size (40) is below target limit (100). Findings should be interpreted as directional SFT evidence.
...
* **Router Safety:** The Protected Router preserved served SFT consistency with zero regressions observed.
