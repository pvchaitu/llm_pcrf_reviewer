...
This mathematical approach isolates low-impact prompts (which `GPT2` has already memorized with low NLL and sensitivity) and concentrates compute resources on abstract syntax and structured dependencies.
