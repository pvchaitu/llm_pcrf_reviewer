    ...
    def evaluate_dataset_detailed(
        ...
        with torch.no_grad():
            for batch in loader:
                ...
                # Metric 4 & 5: Instruction Contract Violation / Over-generation
...
class StructuralPCRFPlugin(BaseFeaturePlugin):
    ...
    def run_standalone(self, model: PreTrainedModel, tokenizer: PreTrainedTokenizer, splits: Dict[str, List[ClozeQAExample]], cfg: PCRFConfig) -> Any:
        ...
        for idx, r_l in enumerate(layer_reliabilities):
            ...
            # Cumulative structural residual-stream recursion (Part B)
            r_bypass = r_prev
            ...
            structural_atmap_delta_prob = calibrated_beta * d_l
            
            # Compute CREW-Birnbaum Drift Sensitivity Index (B_l^CREW) (Part C)
...
class SafePCRFController:
    ...
    def compute_promotion_decision_v2(
        ...
        baseline_metrics: Dict[str, Any],
        feature_metrics: Dict[str, Any],
        feature_name: str = "regularization",  # <--- ADD DEFAULT FALLBACK HERE
...
def compute_experiment_summary(
    ...
    for r in trace_rows:
        # Standardize '_to_' to '->' representation to avoid KeyError mismatch
...
class ExecutiveReportGenerator:
    ...
    def generate_report(
        ...
        feat_metrics_gating = {
            ...
            "seen_nll": summary.seen_nll.candidate,
            "unseen_nll": summary.unseen_nll.candidate,
