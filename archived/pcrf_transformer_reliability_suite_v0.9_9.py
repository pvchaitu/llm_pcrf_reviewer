...
def parse_cli_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default="full",
        help="Execution mode: baseline runs baseline-only evaluation; full runs baseline + PCRF."
    )
...
def write_baseline_only_artifacts(
    ...
    logger.info(f"Baseline-only artifacts written to: {output_dir}")
