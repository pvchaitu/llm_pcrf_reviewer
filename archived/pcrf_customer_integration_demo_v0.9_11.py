...
def main(run_mode: str = "full", dataset_path: Optional[str] = None):
    ...
    if run_mode == "baseline":
        ...
        base_train_metrics = EvaluatorPlus.evaluate_dataset_detailed(model_base, tokenizer, train_val_dataset, pcrf_config.model_cfg)
        base_ood_metrics = EvaluatorPlus.evaluate_dataset_detailed(model_base, tokenizer, ood_val_dataset, pcrf_config.model_cfg)
