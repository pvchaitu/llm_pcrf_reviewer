...
class PromotionGateConfig:
    ...
    # FIX 1 — CONFIG FIELDS FOR HARD PROMOTION GATES
...
# ==============================================================================
# SECTION C. CANONICAL DATACLASSES & SCHEMAS (FULLY DEDUPLICATED)
# ==============================================================================
...
class EvidenceProvenanceBundle:
    ...
    structural_status: str  # STRUCTURAL_PROMOTION_GRADE, STRUCTURAL_MEASUREMENT_ONLY, etc.
    router_status: str
    direct_weight_promotion_status: str
...
def validate_executive_report_claims_strengthened(report_text: str, summary: ExperimentComputedSummary) -> List[str]:
    ...
    if "measurement-only components: candidate weights" in report_text.lower() and summary.final_direct_promotion_decision == "SAFE_TO_APPLY":
        errors.append("Report classifies SFT candidate weights as 'Measurement-Only' when they are safe.")
...
class ProtectedRouter:
    ...
    def route_inference(
        ...
        if base_correct == 1 and cand_correct == 0:
            ...
            # Both wrong: Do NOT use candidate, fallback to baseline diagnostic mode
            self.both_wrong += 1
            decision = "baseline"  # Serve baseline fallback
        else:
            self.both_correct += 1
            # If both are correct, choose lower-risk output
...
class ExecutiveReportGenerator:
    ...
    def generate_report(
        ...
        reconciliation = generate_structural_reconciliation_text(multitier_reliability, cfg, bypass_dominated)
        ...
        # Assemble canonical Markdown strictly retaining the requested heading exactly
...
"""
        ...
        # Perform rigorous self-validation checks
        if cfg.reporting_cfg.report_strict_validation:
            errors = validate_executive_report_claims_strengthened(md, summary)
            if errors:
...
def run_post_experiment_self_checks(
    ...
    # 1. FIX 2 AST deduplication assertion
