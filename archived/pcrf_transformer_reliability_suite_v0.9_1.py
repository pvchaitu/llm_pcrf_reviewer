...
class RegularizationConfig:
    ...
    lambda_contrastive: float = 0.5  # Suppressor strength
        ...
        for batch in loader:
            ...
            if active_mask.any() and len(mc_token_ids) > 0:
                ...
                if valid_mc_token_ids:
                    ...
                    # Bounded, scale-invariant probability minimizer
            ...
            # Wrap KL loss strictly over active semantic tokens to prevent token mismatches
