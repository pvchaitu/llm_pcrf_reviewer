...
> ℹ️ Claim Calibration Notice: One statement in the report used stronger wording than supported by the validation sample size.
This has been automatically flagged to ensure all claims remain statistically grounded and deployment-safe.
...
| Unseen Validation NLL | Lower is Better ⬇️ | 4.1787 | 3.8745 | 4.1787 | -0.3042 | +0.0000 | Candidate Improved (-0.3042), Served Unchanged (+0.0000). |
| Unseen Perplexity (PPL) | Lower is Better ⬇️ | 65.2841 | 48.1609 | 65.2841 | -17.1232 | +0.0000 | Candidate Improved (-17.1232), Served Unchanged (+0.0000). |
...
| Instruction Contract Violation Rate | Lower is Better ⬇️ | 92.50% | 100.00% | 92.50% | +7.50% | +0.00% | Candidate Worsened (+0.0750%), Served Unchanged (+0.0000%). |
| Average Cross-Entropy Loss (NLL) | Lower is Better ⬇️ | 4.2497 | 3.8030 | 4.1849 | -0.4467 | -0.0648 | Candidate Improved (-0.4467), Served Improved (-0.0648). |
