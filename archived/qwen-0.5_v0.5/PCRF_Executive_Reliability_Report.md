...
| **Seen Validation Loss (NLL)** | 4.54374 | 3.61836 | -0.92538 |
| **Unseen Validation Loss (NLL)** | 4.26385 | 3.75721 | -0.50664 |
| **Unseen Perplexity (PPL)** | 71.08 | 42.83 | -28.25 |
...
This mathematical approach filters out low-impact prompts and prioritizes abstract syntax and logical structures. For example, `QWEN/QWEN2.5-0.5B` consistently struggles with advanced computer science and coding syntax prompts (high priority scores), while basic factual lookups (like capitals) remain stable.
...
A. Fluor` | `____
A. Fluor` | 3.4583 |
| seen_val | 89 | *The yellow dwarf star supporting life at the center of our solar system is the* | `Sun` | `most distant star in the Milky` | `most distant object in the Milky` | 3.2344 |
...
A. Logical` | 11.1875 |
| seen_val | 99 | *A standardized text notation representing complex structural records is* | `JSON` | `used in the field of structural` | `used in the following way:` | 9.5625 |
| seen_val | 100 | *The active keyword used to bind external packages into Python script scopes is* | `import` | `____
A. from` | `____
A. def` | 7.3438 |
| unseen_val | 106 | *Mammalian red blood cells are chemically responsible for transporting vital* | `Oxygen` | `substances in the body. Which` | `substances in the body. They` | 10.0000 |
