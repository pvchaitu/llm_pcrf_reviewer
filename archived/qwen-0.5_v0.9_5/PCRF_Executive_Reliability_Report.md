...
* **Strict EM Impact Warning:** Although likelihood metrics improved, strict target-only exact-match compliance declined from 7.50% to 0.00%, showing that the candidate is not safe for contract-constrained generation without router governance.
